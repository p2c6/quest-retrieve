                ...
                <div class="container mx-auto w-auto md:w-96 mt-16">
                    <div v-if="authStore.message" class="bg-teal-100 border-t-4 border-teal-500 rounded-b text-teal-900 px-4 py-3 shadow-md mb-5" role="alert">
                        <div class="flex">
                            ...
                            <div>
                            <p class="font-bold text-sm">Your password changed!</p>
                            <div class="text-xs flex gap-1">You can click log-in and try it now.
                                <RouterLink :to="{name: 'login'}">
                                    <div class="underline text-primary font-semibold"> Login</div>
                                </RouterLink>
