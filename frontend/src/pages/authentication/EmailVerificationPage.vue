                ...
                <div class="container mx-auto w-auto md:w-96 mt-24">
                    <form @submit.prevent="authStore.login(credentials)">
                        <div>
                            ...
                            <div>
                                <p class="text-gray-400 text-sm md:text-md">We have sent an e-mail verification link to your e-mail which expires within 1 hour. Please check your e-mail and click the link provided in the e-mail to complete your account registration.</p>
                            </div>
