        ...
        <div class="overflow-x-auto w-full">
            <div class="flex flex-col gap-2 justify-between items-center md:flex-row">
                ...
                <div class="w-full md:w-16">
                    <RouterLink :to="{ name: 'role.create' }">
            ...
            <div class="w-full mt-5 relative overflow-x-auto shadow-md sm:rounded-lg">
                <div v-if="roleStore.message" class="bg-teal-100 border-t-4 border-teal-500 rounded-b text-teal-900 px-4 py-3 shadow-md mb-5" role="alert">
                        <div class="flex">
                            <div class="py-1">
                    ...
                    <div v-if="roleStore.errors && roleStore.errors.message" class="bg-red-100 border-t-4 border-red-500 rounded-b text-red-900 px-4 py-3 shadow-md mb-5" role="alert">
                        <div class="flex">
                            <div class="py-1">
                            ...
                            <div>
                                ...
                                <div class="text-xs flex gap-1">{{ roleStore.errors.message }}
                                </div>
                            </div>
                        </div>
                    </div>
                    <div role="status" v-if="roleStore.isLoading" class="flex items-center justify-center mt-10">
                    ...
                    <table class="w-full text-sm text-left rtl:text-right text-gray-500 dark:text-gray-400" v-else>
                        ...
                        <tbody>
                            <tr v-if="roleStore.roles.data.length > 0" v-for="role in roleStore.roles.data" :key="role.id" class="odd:bg-white odd:dark:bg-gray-900 even:bg-gray-50 even:dark:bg-gray-800 border-b dark:border-gray-700">
                                <th scope="row" class="px-6 py-4 font-medium text-gray-900 whitespace-nowrap dark:text-white">
                                    {{ role.name }}
                                </th>
                                <td class="px-6 py-4">
                                    <div class="flex gap-2">
                                        <RouterLink :to="{name: 'role.edit', params:{ id: role.id } }" class="font-medium text-blue-600 dark:text-blue-500 hover:underline">
                                            <i class="text-primary pi pi-pen-to-square cursor-pointer"> Edit</i>
                                        </RouterLink>
                                        <div class="text-red-500 cursor-pointer" @click="openDeleteRoleConfirmation(role.id)">
                    ...
                    <div class="flex justify-center md:justify-end mt-2">
                        ...
                        @pagination-change-page="roleStore.getAllRoles"
                    />
                    </div>
            </div>
        </div>
