...
const search = async() => {
    await props.onSearch(formData.keyword)
}
    ...
    <Card class="p-5 flex flex-row mt-2  w-full">
        <div class="overflow-x-auto w-full">
            ...
            <div class="w-full mt-5 relative overflow-x-auto shadow-md sm:rounded-lg">
                <div v-if="message" class="bg-teal-100 border-t-4 border-teal-500 rounded-b text-teal-900 px-4 py-3 shadow-md mb-5" role="alert">
                        <div class="flex">
                            <div class="py-1">
                    ...
                    <div v-if="errors && errors.message" class="bg-red-100 border-t-4 border-red-500 rounded-b text-red-900 px-4 py-3 shadow-md mb-5" role="alert">
                        <div class="flex">
                            <div class="py-1">
                            ...
                            <div>
                                ...
                                <div class="text-xs flex gap-1">{{ errors.message }}
                                </div>
                            </div>
                        </div>
                    </div>
                    <div role="status" v-if="isLoading" class="flex items-center justify-center mt-10">
